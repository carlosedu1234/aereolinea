  ...
  return (
    <div>
      ...
      <form  onSubmit={handleSubmit(obtenerValores)}> 
        ...
        <input id="nombre" placeholder='Nombre Ciudad' autoFocus 
        {...register("nombre",{
            required:true,
            maxLength:15,
        ...
        />
          ...
          {errors.nombre?.type==="required" &&
            <div className="conteiner-mensaje">El nombre de la ciudad es obligatoria</div>
            }
        ...
        <input id="zona" placeholder='Zona' autoFocus 
        {...register("zona",{
            required:true,
            maxLength:2})}
        />
          ...
          {errors.zona?.type==="required" &&
            <div className="conteiner-mensaje">La zona de la ciudad es obligatoria</div>
            }
            {errors.zona?.type==="maxLength" &&
            <div className="conteiner-mensaje">La zona tiene un maximo de dos querecteres</div>
            }

          <div className='conteiner-datos'>
        <label htmlFor="descripcion">Descripcion:</label>
        <input id="descripcion" placeholder='Descripcion' autoFocus 
        {...register("descripcion",{
            required:true,})}
        />
          </div>
          {errors.descripcion?.type==="required" &&
            <div className="conteiner-mensaje">La descripcion de la ciudad es obligatoria</div>
            }
          <div className='conteiner-datos'>
        <label htmlFor="imagen">Imagen:</label>
        <input id="imagen" placeholder='Imagen' autoFocus 
        {...register("imagen",{
            required:true,
        ...
        />
          ...
          {errors.imagen?.type==="required" &&
            <div className="conteiner-mensaje">La imagen de la ciudad es obligatoria</div>
            }
            {errors.imagen?.type==="pattern" &&
            <div className="conteiner-mensaje">La imagen tiene que ser una url</div>
            }
        ...
        <input id="precio" placeholder='Precio' type="number"  autoFocus 
        {...register("precio",{
            required:true,
        ...
        />
            ...
            <div className="conteiner-mensaje">El precio de la ciudad es obligatoria</div>
            }
             {errors.precio?.type==="validate" &&
            <div className="conteiner-mensaje">El precio de la ciudad tiene que ser mayor a cero</div>
            }
